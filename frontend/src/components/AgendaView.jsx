...
export const SCHEDULE = [
  ...
  },
  {
    time: '10:40',
    dur: '25 דק׳',
    title: 'מפרויקטים נקודתיים להטמעת AI ארגונית: מה למדנו בדרך במכבי',
    desc: 'קובי כץ, סמנכ״ל וראש חטיבת טכנולוגיות, מכבי שירותי בריאות · סיפור לקוח',
    kind: 'anchor',
  },
  {
    time: '11:05',
    dur: '25 דק׳',
    title: 'כשאין מקום לטעויות: AI מאובטח, בהיקף ובסביבות רגישות',
    desc: 'ערן דהן, מפא״ת · סיפור לקוח',
    kind: 'anchor',
  },
  {
    time: '11:30',
  ...
  },
  {
    ...
    people: [
      ...
      { name: 'חנה שילדר', role: 'מנהלת מגזר דיגיטל, אנליטיקה ו-AI, חברת החשמל' },
    ],
  },
  {
    time: '12:45',
